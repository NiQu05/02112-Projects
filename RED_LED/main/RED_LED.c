...
void app_main(void)
{
    ...
    xTaskCreate(RED_LED, "RED_LED", 4096, NULL, 1, NULL);
    xTaskCreate(RGB_LED, "RGB_LED", 4096, NULL, 1, NULL);
    xTaskCreate(BUZZ, "BUZZ", 4096, NULL, 1, NULL);
